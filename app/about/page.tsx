  ...
  return (
    <main className="pt-16 sm:pt-20">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8">
              Somos uma empresa líder em desenvolvimento de software e transformação digital,
              comprometida em impulsionar a inovação e o crescimento dos nossos clientes.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-6">Nossa Missão</h2>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                Capacitar empresas através da tecnologia, fornecendo soluções inovadoras
                que impulsionam o crescimento e a eficiência operacional.
              </p>
      ...
      <section className="py-12 sm:py-16 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl sm:text-3xl font-bold text-center mb-12">Nossa Equipe</h2>
      ...
      <section className="py-12 sm:py-16 bg-green-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
            Junte-se a nós na missão de transformar o futuro digital das empresas.
          </p>
...
function TeamMember({ image, name, role, description }: { image: string; name: string; role: string; description: string }) {
  return (
    <div className="text-center">
      ...
      <p className="text-green-600 dark:text-green-400 font-medium mb-2">{role}</p>
      <p className="text-sm text-gray-600 dark:text-gray-300">{description}</p>
    </div>
  );
}